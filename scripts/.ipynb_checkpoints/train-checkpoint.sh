...
# ==============================================================================
#  Usage:
#    bash scripts/train.sh hero                    # splatfacto, 500 iters (quick test)
#    bash scripts/train.sh hero 30000              # splatfacto, full training  
#    bash scripts/train.sh hero 30000 2 dc_splat   # DreamCatalyst + 2x downscale
# ==============================================================================
